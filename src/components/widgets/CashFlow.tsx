...
const CashFlow: FunctionComponent<CashFlowType> = ({
  className = "",
  income,
  cAD,
  paymentsReceived,
  ...
  return (
    <div
      className={`flex-1 rounded bg-white flex flex-col items-start justify-start py-2.5 px-3 gap-[6px] text-left text-xs text-dimgray font-roboto border-[1px] border-solid border-lightgray ${className}`}
    >
